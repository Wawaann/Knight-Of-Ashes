...
void scn_one(scene_t *scn, game_t *game)
{
    ...
    scn->text[0] = create_text(font, "Use LEFT RIGHT arrows to move",
                                20, V2F(350, 420));
    scn->text[1] = create_text(font, "Use SPACE to jump", 25, V2F(1500, 420));
    scn->text[2] = create_text(font, "use R to roll", 25, V2F(2400, 420));
    scn->text[3] = create_text(font, "use Z or E to attack",
                                25, V2F(3100, 420));
    scn->text[4] = create_text(font, "use A to interact with object",
                                25, V2F(4350, 500));
